...
#define SSID "Pagla kutta" //replace XXXXX by your router SSID
#define PASS "kuttar-baccha" //replace YYYYY by your router password
...
void loop(){
  ...
  if ((millis() - starttime) >= sampletime_ms)
  {
    ...
    Serial.print("Soil sensor (Mositure ) :");
    ...
    Serial.println(dustStr);
    Serial.println(pressureStr);
    Serial.println(temperature1Str);
